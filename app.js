...
function receivedMessage(event) {
  ...
  if (messageText) {
    ...
    sendTextMessage(
      senderID,
      "Unavailable, please use related keywords: html, css, JS"
    );
  }
}
    ...
    fb.api(
      ...
      user => {
        ...
        sendTextMessage(senderID, text, function() {
          sendTextMessage(
            senderID,
            "To get you started use one of these keywords: `html`, `php`, `test automation`, ...etc. Or you can normally ask by typing any kind of a question like: `what is python`?",
            function() {
